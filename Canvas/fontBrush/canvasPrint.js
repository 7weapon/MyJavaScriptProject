...
;(function () {
    ...
    CanvasPrint.prototype = {
        ...
        opControl: function () {
            ...
            _this.cvs.addEventListener('touchstart', function (e) {
                e.preventDefault();
                isMouseDown = true;
                var touch = e.touches[0];
                lastLoc = _this.windowToCanvs(touch.pageX, touch.pageY);
            });
            _this.cvs.addEventListener('touchend', function (e) {
                e.preventDefault();
                isMouseDown = false;
            });
            _this.cvs.addEventListener('touchmove', function (e) {
                e.preventDefault();
                if (isMouseDown) {
                    var touch = e.touches[0];
